...
def print_page(request):
    ingredient_result = Recipe.objects.raw('select * from recipe, recipe_ingredient where recipe.id == 2551 AND recipe.id == recipe_ingredient.recipe_id')
    result = Recipe.objects.raw('select * from recipe where recipe.id == 2551')
